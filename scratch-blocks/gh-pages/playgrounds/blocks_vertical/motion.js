...
Blockly.Blocks['motion_movespin'] = {
  /**
   * Block to move steps.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MOTION_MOVESPIN,
      "args0": [
        {
          "type": "input_value",
          "name": "STEPS"
...
Blockly.Blocks['motion_gridmove'] = {
 /**
 ...
 */
 init: function() {
  this.jsonInit({
   "message0": Blockly.Msg.MOTION_GRIDMOVE,
   "args0": [
    {
     "type": "input_value",
     "name": "STEPS"
...
Blockly.Blocks['motion_left'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MOTION_LEFT,
      "args0": [
        {
          "type": "field_image",
          "src": Blockly.mainWorkspace.options.pathToMedia + "rotate-left.svg",
...
Blockly.Blocks['motion_right'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MOTION_RIGHT,
      "args0": [
        {
          "type": "field_image",
          "src": Blockly.mainWorkspace.options.pathToMedia + "rotate-right.svg",
